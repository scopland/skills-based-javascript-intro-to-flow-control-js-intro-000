...
function ageChecker(age) {if (age>=13 && age<=19) {return "You are a teenager!"} else if (age<=12) {return "You are a kid"} else {return "You are a grownup"}
...
function switchAge(age) {switch(age) {case age<=19 && age>=13:return 'You are a teenager'; break; default: return 'You have an age';}
